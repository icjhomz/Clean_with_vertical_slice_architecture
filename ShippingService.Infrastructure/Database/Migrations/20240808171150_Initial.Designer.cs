...
namespace ShippingService.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240808171150_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShippingService.Domain.Shipments.Entities.Shipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ShippingService.Domain.Shipments.Entities.ShipmentItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ShippingService.Domain.Shipments.Entities.Shipment", b =>
                {
                    b.OwnsOne("ShippingService.Domain.Shipments.Entities.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("ShippingService.Domain.Shipments.Entities.ShipmentItem", b =>
                {
                    b.HasOne("ShippingService.Domain.Shipments.Entities.Shipment", "Shipment")
                        .WithMany("Items")
                        .HasForeignKey("ShipmentId")
